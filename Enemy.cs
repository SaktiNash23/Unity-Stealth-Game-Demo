...
//Script Description: Contains logic that drives the enemy AI using a state machine. Calculations for line of sight, shifting between various enemy
//                      states, enemy actions in specific states can all be found here
